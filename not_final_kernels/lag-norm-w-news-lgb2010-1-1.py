...
def main():
    ...
    market_train_df, features.news = model.create_dataset(market_train_df, features.news, features.news_feature_names,
                                                          train_batch_size=100, valid_batch_size=100)
    model.train()
    #
    ...
    predict_all(days, env, linker, market_preprocess, model, features.news_feature_names, news_preprocess, pipeline)
...
class MarketNewsLinker(object):
    ...
    def aggregate_day_asset_news(self):
        ...
        self.market_df["marketCommentary"] = self.market_df["marketCommentary"].astype("uint8")
    ...
    def create_new_market_df(self):
        ...
        # self.market_df = self.market_df.drop(dropped_columns, axis=1)
...
def predict_all(days, env, linker, market_preprocess, model, news_feature_names, news_preprocess, pipeline):
