...
def main():
    ...
    market_train_df, news_feature_names, pipeline = Features.post_merge_feature_extraction(features, market_train_df)
...
class Features(object):
    ...
    def post_merge_feature_extraction(features, market_train_df):
        ...
        lag_transformer = LagAggregationTransformer([3, 7, 14], shift_size=1)
...
class LagAggregationTransformer(DfTransformer):
    ...
    def __init__(self, lags, shift_size, scale=True):
        self.lags = lags
    ...
    @measure_time
    def transform(self, df: pd.DataFrame, n_pool=10):
